...
void	Class_CANDrv::Drv_CANInit()
{
	...
	CANMessageSet(CANA_BASE, MAIL_BOX4|MAIL_BOX5, &sRXCANMessage, MSG_OBJ_TYPE_RX);
	...
	CANEnable(CANB_BASE);
	CANMessageSet(CANA_BASE, MAIL_BOX6|MAIL_BOX7|MAIL_BOX8|MAIL_BOX9, &sRXCANMessage, MSG_OBJ_TYPE_RX);
}
 ...
 //*****************************************************************************
#ifdef DEBUG
 bool Class_Drv::CANBaseValid(uint32_t ui32Base)
 {
...
//*****************************************************************************
 ...
 //
 //*****************************************************************************
 int32_t Class_CANDrv::CANIntNumberGet(uint32_t ui32Base, unsigned char ucNumber)
 {
	 int32_t lIntNumber;
 ...
 //
 //*****************************************************************************
 void Class_CANDrv::CANDataRegWrite(unsigned char *pucData, uint32_t *pui32Register, int16_t iSize)
 {
	 int16_t iIdx;
 ...
 //
 //*****************************************************************************
 void Class_CANDrv::CANDataRegRead(unsigned char *pucData, uint32_t *pui32Register, int16_t iSize)
 {
	 int16_t iIdx;
	 unsigned char * pucRegister = (unsigned char *) pui32Register;
 ...
 //
 //*****************************************************************************
 void Class_CANDrv::CANInit(uint32_t ui32Base)
 {
	 int16_t iMsg;
 ...
 //
 //*****************************************************************************
 void Class_CANDrv::CANEnable(uint32_t ui32Base)
 {
	 // Check the arguments.
	 ASSERT(CANBaseValid(ui32Base));
 ...
 //
 //*****************************************************************************
 void Class_CANDrv::CANDisable(uint32_t ui32Base)
 {
	 // Check the arguments.
	 ASSERT(CANBaseValid(ui32Base));
 ...
 //
 //*****************************************************************************
 void Class_CANDrv::CANClkSourceSelect(uint32_t ui32Base, uint16_t ui16Source)
 {
	 EALLOW;
	 switch(ui32Base)
	 {
 ...
 //
 //*****************************************************************************
 void Class_CANDrv::CANBitTimingGet(uint32_t ui32Base, tCANBitClkParms *pClkParms)
 {
	 uint32_t uBitReg;
 ...
 //
 //*****************************************************************************
 uint32_t Class_CANDrv::CANBitRateSet(uint32_t ui32Base, uint32_t ui32SourceClock, uint32_t ui32BitRate)
 {
 ...
 //
 //*****************************************************************************
 void Class_CANDrv::CANBitTimingSet(uint32_t ui32Base, tCANBitClkParms *pClkParms)
 {
	 uint32_t uBitReg;
	 uint16_t uSavedInit;
 ...
 //
 //*****************************************************************************
 void Class_CANDrv::CANIntEnable(uint32_t ui32Base, uint32_t ui32IntFlags)
 {
	 // Check the arguments.
	 ASSERT(CANBaseValid(ui32Base));
 ...
 //
 //*****************************************************************************
 void Class_CANDrv::CANIntDisable(uint32_t ui32Base, uint32_t ui32IntFlags)
 {
	 // Check the arguments.
	 ASSERT(CANBaseValid(ui32Base));
	 ASSERT((ui32IntFlags & ~(CAN_INT_ERROR | CAN_INT_STATUS | CAN_INT_IE0 |
 ...
 //
 //*****************************************************************************
 uint32_t Class_CANDrv::CANIntStatus(uint32_t ui32Base, tCANIntStsReg eIntStsReg)
 {
	 uint32_t ui32Status;
 ...
 //
 //*****************************************************************************
 void Class_CANDrv::CANIntClear(uint32_t ui32Base, uint32_t ui32IntClr)
 {
	 // Check the arguments.
	 ASSERT(CANBaseValid(ui32Base));
 ...
 //
 //*****************************************************************************
 void Class_CANDrv::CANRetrySet(uint32_t ui32Base, bool bAutoRetry)
 {
	 uint16_t ui16CtlReg;
 ...
 //
 //*****************************************************************************
 bool Class_CANDrv::CANRetryGet(uint32_t ui32Base)
 {
	 // Check the arguments.
	 ASSERT(CANBaseValid(ui32Base));
 ...
 //
 //*****************************************************************************
 uint32_t	Class_CANDrv::CANStatusGet(uint32_t ui32Base, tCANStsReg eStatusReg)
 {
	 uint32_t ui32Status;
 ...
 //
 //*****************************************************************************
 bool Class_CANDrv::CANErrCntrGet(uint32_t ui32Base, uint32_t *pui32RxCount,
 ...
 //
 //*****************************************************************************
 void Class_CANDrv::CANMessageSet(uint32_t ui32Base, uint32_t ui32ObjID, tCANMsgObject *pMsgObject,
 ...
 //
 //*****************************************************************************
 void Class_CANDrv::CANMessageGet(uint32_t ui32Base, uint32_t ui32ObjID, tCANMsgObject *pMsgObject,
			   bool bClrPendingInt)
 {
	 uint32_t ui32CmdMaskReg;
	 uint32_t ui32MaskReg;
 ...
 //
 //*****************************************************************************
 void	Class_CANDrv::CANMessageClear(uint32_t ui32Base, uint32_t ui32ObjID)
 {
	 // Check the arguments.
	 ASSERT(CANBaseValid(ui32Base));
 ...
 //
 //*****************************************************************************
 void Class_CANDrv::CANGlobalIntEnable(uint32_t ui32Base, uint32_t ui32IntFlags)
 {
	 // Check the arguments.
	 ASSERT(CANBaseValid(ui32Base));
 ...
 //
 //*****************************************************************************
 void	Class_CANDrv::CANGlobalIntDisable(uint32_t ui32Base, uint32_t ui32IntFlags)
 {
	 // Check the arguments.
	 ASSERT(CANBaseValid(ui32Base));
	 ASSERT((ui32IntFlags & ~(CAN_GLB_INT_CANINT0 |
 ...
 //
 //*****************************************************************************
 void Class_CANDrv::CANGlobalIntClear(uint32_t ui32Base, uint32_t ui32IntFlags)
 {
	 // Check the arguments.
	 ASSERT(CANBaseValid(ui32Base));
	 ASSERT((ui32IntFlags & ~(CAN_GLB_INT_CANINT0 |
 ...
 //
 //*****************************************************************************
 bool Class_CANDrv::CANGlobalIntstatusGet(uint32_t ui32Base, uint32_t ui32IntFlags)
 {
	 // Check the arguments.
	 ASSERT(CANBaseValid(ui32Base));
	 ASSERT((ui32IntFlags & ~(CAN_GLB_INT_CANINT0 |
