...
void Class_IPC::Drv_IPC_ADSample_Receive(void)
{
	...
	this->IPC_DataRead(IPC_RECEIVE_FLAG2, HWRE(VBUS_PfromREC), objADDrv.m_i16ADC_VbusP_0);
	this->IPC_DataRead(IPC_RECEIVE_FLAG3, HWRE(VBUS_NfromREC), objADDrv.m_i16ADC_VbusN_0);
...
void	Class_IPC::Drv_IPC_ADSample_Transmit(void)
{
	...
	this->IPC_DataWrite(IPC_TRANSMIT_FLAG2), HWRE(VIN_AtoREC), objADDrv.m_i16ADC_Vina_0);
	this->IPC_DataWrite(IPC_TRANSMIT_FLAG3), HWRE(VIN_BtoREC), objADDrv.m_i16ADC_Vinb_0);
	this->IPC_DataWrite(IPC_TRANSMIT_FLAG4), HWRE(VIN_CtoREC), objADDrv.m_i16ADC_Vinc_0);
