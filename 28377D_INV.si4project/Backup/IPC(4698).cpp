...
void    Class_IPC::Drv_IPC_ADSample_Receive(UINT16 &VbusP_0, UINT16 &VbusN_0)
{
    ...
    this->IPC_DataRead(IPC_RECEIVE_FLAG2, HWRE(VBUS_PfromREC), VbusP_0);
	this->IPC_DataRead(IPC_RECEIVE_FLAG3, HWRE(VBUS_NfromREC), VbusN_0);
...
void	Class_IPC::Drv_IPC_ADSample_Transmit(UINT16 &Vina_0, UINT16 &Vinb_0, UINT16 &Vinc_0)
{
    ...
    this->IPC_DataWrite(IPC_TRANSMIT_FLAG2, HWRE(VIN_AtoREC), Vina_0);
    this->IPC_DataWrite(IPC_TRANSMIT_FLAG3, HWRE(VIN_BtoREC), Vinb_0);
    this->IPC_DataWrite(IPC_TRANSMIT_FLAG4, HWRE(VIN_CtoREC), Vinc_0);
