...
inline  UINT16 Class_IPC::IPC_DataWrite(const UINT32 & ulFlag, UINT16 * ulAddress const, UINT16 & ulData)
{
    //
 ...
 //
 //*****************************************************************************
 inline UINT16 Class_IPC::IPC_DataRead(const UINT32 & ulFlag, UINT16 * ulAddress const, UINT16 & ulData)
 {
     //
