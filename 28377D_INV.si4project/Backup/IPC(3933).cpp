...
UINT16 Class_IPC::IPC_DataWrite(const UINT32 & ulFlag, UINT16 * ulAddress, UINT16 * ulData)
	UINT16 returnStatus;
 ...
 //
 //*****************************************************************************
 UINT16 Class_IPC::IPC_DataRead(const UINT32 & ulFlag, UINT16 * ulAddress, UINT16 * ulData)
