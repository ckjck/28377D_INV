...
//
const UINT32 ADDRESS_CPU1TOCPU2_A = 0x03FC07;
const UINT32 ADDRESS_CPU1TOCPU2_B = 0x03FC08;
const UINT32 ADDRESS_CPU1TOCPU2_C = 0x03FC09;

const UINT32 VIN_AtoREC			  = 0x03FC10;
const UINT32 VIN_BtoREC			  = 0x03FC11;
const UINT32 VIN_CtoREC			  = 0x03FC12;

const UINT32 ADDRESS_CPU2TOCPU1_A = 0x03F807;
const UINT32 ADDRESS_CPU2TOCPU1_B = 0x03F808;
const UINT32 ADDRESS_CPU2TOCPU1_C = 0x03F809;

const UINT32 VBUS_PfromREC		  = 0x03FC10;
const UINT32 VBUS_NfromREC		  = 0x03FC11;
...
class	Class_IPC
	...
	public:
		...
		void		Drv_IPC_ADSample_Transmit
		void		Drv_IPC_ADSample_Receive(INT16 & VbusP_0, INT16 & VbusN_0);
