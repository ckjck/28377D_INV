...
//copy constructor,initial Value 
Class_IPC::Class_IPC( CAN_PACKED_PROTOCOL_U * const p1,  CAN_PACKED_PROTOCOL_U * const p2)
{
    CPU2toCanBus = p1;
    CanBustoCPU2 = p2;
	m_un_CPU1toCPU2.all = 0;
	m_un_CPU2toCPU1.all = 0;
}
...
void    Class_IPC::Drv_IPC_ADSample_Receive(void)
{
    ...
    this->IPC_DataRead(IPC_RECEIVE_FLAG2, HWRE(VBUS_PfromREC), (UINT16)VbusP_0);
	this->IPC_DataRead(IPC_RECEIVE_FLAG3, HWRE(VBUS_NfromREC), (UINT16)VbusN_0);
...
//
void	Class_IPC::Drv_IPC_ADSample_Transmit(INT16 &Vina_0, INT16 &Vinb_0, INT16Vinc_0)
{

    this->IPC_DataWrite(IPC_TRANSMIT_FLAG2, HWRE(VIN_AtoREC), (UINT16)(Vina_0));
    this->IPC_DataWrite(IPC_TRANSMIT_FLAG3, HWRE(VIN_BtoREC), (UINT16)(Vinb_0));
    this->IPC_DataWrite(IPC_TRANSMIT_FLAG4, HWRE(VIN_CtoREC), (UINT16)(Vinc_0));
